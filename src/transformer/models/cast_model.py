...
from . import net
from . import MSP
import src.transformer.util.util as util
from src.transformer.util.image_pool import ImagePool
...
class CASTModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        vgg = net.vgg
        vgg.load_state_dict(torch.load('./src/transformer/models/vgg_normalised.pth'))
