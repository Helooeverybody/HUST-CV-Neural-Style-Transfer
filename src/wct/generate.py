...
def main(style_img_dir,content_img_dir,save_dir, model_path, content_size_mult, style_size_mult, alpha, color_ratio, DEVICE, limit_num):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--style_img_dir", type=str, default="../../datasets/styles"
    )
    parser.add_argument(
        "--content_img_dir", type=str, default = "../../datasets/contents"
    )
    parser.add_argument(
    ...
    main(
        ...
        limit_num=parser.parse_args().limit_num
    )
